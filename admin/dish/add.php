        ...
        <main class="col-md-9 ms-sm-auto col-lg-10 px-md-4">
            ...
            <form id="create" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
                <div class="mb-3">
                    ...
                    <input type="text" name="dish" id="dish" class="form-control" required>
                ...
                <div class="mb-3">
                    ...
                    <textarea name="recipes" id="recipes" rows="3" class="form-control" required></textarea>
                ...
                <div class="mb-4">
                    ...
                    <div class="image-card">
                        ...
                        <div class="control-button edit-button" id="updateButton" data-id=""
                             title="Обновить">
                        ...
                        <div class="control-button delete-button" id="deleteButton" data-id=""
                             title="Удалить">
                            <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor"
                                 class="bi bi-x"
                                 viewBox="0 0 16 16">
